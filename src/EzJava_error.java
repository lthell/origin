...
public class EzJava_error 
{
  public static void main(String[] args) 
  {
    ...
    {                                                                        
      ...
      rs = stmt.executeQuery("SELECT EMPNO, FIRSTNME, MIDINIT, LASTNAME FROM DSN8810.EMP");                    
      ...
      while (rs.next()) {
        ...
        System.out.println("Employee number = " + empNo + " Firstname = " + empFirstname + " Lastname = " + empLastname);
      }
      ...
      //con.close();                                                              
      System.out.println("**** Not Disconnected from data source");
